...
/*/{Protheus.doc} User Function zOO17
...
User Function zOO17()
    ...
    oDialogPvt := TDialog():New(0, 0, nJanAltura, nJanLargur, cJanTitulo, , , , , , nCorFundo, , , lDimPixels)
        ...
        @ 001, 001 SCROLLBOX oScroll VERTICAL HORIZONTAL SIZE nJanAltura / 2 -20, nJanLargur / 2 -1 OF oDialogPvt
            ...
            nObjLargu := 40
            nObjAltur := 6
            oSayObj0  := TSay():New(nObjLinha, nObjColun, {|| cSayObj0}, oScroll, /*cPicture*/, oFontPadrao, , , , lDimPixels, /*nClrText*/, /*nClrBack*/, nObjLargu, nObjAltur, , , , , , /*lHTML*/)
            ...
            nObjLargu := 100
            nObjAltur := 10
            oGetObj1  := TGet():New(nObjLinha, nObjColun, {|u| Iif(PCount() > 0 , xGetObj1 := u, xGetObj1)}, oScroll, nObjLargu, nObjAltur, /*cPict*/, /*bValid*/, /*nClrFore*/, /*nClrBack*/, oFontPadrao, , , lDimPixels)
            ...
            nObjLargu := 100
            nObjAltur := 10
            oGetObj3  := TGet():New(nObjLinha, nObjColun, {|u| Iif(PCount() > 0 , xGetObj3 := u, xGetObj3)}, oScroll, nObjLargu, nObjAltur, /*cPict*/, /*bValid*/, /*nClrFore*/, /*nClrBack*/, oFontPadrao, , , lDimPixels)
